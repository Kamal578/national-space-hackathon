  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        drought: {
          DEFAULT: 'hsl(var(--drought))',
          light: 'hsl(var(--drought-light))',
          foreground: 'hsl(var(--drought-foreground))'
        },
        severity: {
          ...
          watch: 'hsl(var(--severity-watch))',
          emerging: 'hsl(var(--severity-emerging))',
